...
from model.ner import BertForNER
...
def train_and_evaluate(model, train_data, val_data, optimizer, scheduler, params, model_dir, restore_dir=None):
    ...
    if restore_dir is not None:
        model = BertForNER.from_pretrained(tagger_model_dir)
...
if __name__ == '__main__':
    ...
    # Prepare model
    model = BertForNER.from_pretrained(bert_class, num_labels=len(params.tag2idx))
